...
struct TourPage: Identifiable {
    ...
    static let all: [TourPage] = [
        ...
        TourPage(icon: "square.grid.2x2.fill",
                 ...
                 body: "Tap the grid button to arrange panes: drag to move, pull a corner to resize, tap ✕ to remove. Double-tap any pane for fullscreen. Use a preset — Single, Side-by-side, Stacked, One-bigger, Grid, or Picture-in-picture."),
        TourPage(icon: "globe.americas.fill",
                 title: "Zoom superpowers",
                 body: "Pinch any camera to zoom in on the crib and drag to pan around. Flag a ceiling camera as Fisheye and it's live-dewarped too — tap “Split fisheye” to turn that one camera into several independent close-ups."),
        TourPage(icon: "waveform",
                 title: "Listen in & cry alerts",
                 body: "Tap a pane's speaker to listen; the little bars show the sound level. Cribsight flashes and buzzes when it hears sustained crying — tap the bell to review what happened overnight."),
